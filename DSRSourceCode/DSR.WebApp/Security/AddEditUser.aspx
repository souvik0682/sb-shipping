    ...
    <fieldset style="width:410px;">
        ...
        <table border="0" cellpadding="5" cellspacing="5">
            <tr>
                ...
                <td><asp:TextBox ID="txtUserName" runat="server" MaxLength="10" Width="250"></asp:TextBox></td>
            </tr>
            <tr>
                <td>First Name:<span class="errormessage1">*</span></td>
                <td><asp:TextBox ID="txtFName" runat="server" MaxLength="30" Width="250"></asp:TextBox></td>
            </tr>
            <tr>
                <td>Last Name:<span class="errormessage1">*</span></td>
                <td><asp:TextBox ID="txtLName" runat="server" MaxLength="30" Width="250"></asp:TextBox></td>
            </tr>
            <tr>
                <td>Email Id:<span class="errormessage1">*</span></td>
                <td><asp:TextBox ID="txtEmail" runat="server" MaxLength="100" Width="250"></asp:TextBox></td>
            </tr>
            <tr>
