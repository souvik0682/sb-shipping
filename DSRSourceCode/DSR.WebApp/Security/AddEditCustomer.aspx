        ...
        <fieldset style="width:95%;">
            ...
            <table border="0" cellpadding="0" cellspacing="5" width="100%">
                <tr>
                    ...
                    <td style="width:28%;"><asp:DropDownList ID="ddlGroup" runat="server" CssClass="dropdownlist"><asp:ListItem Value="0" Text="Without Group Company"></asp:ListItem></asp:DropDownList><br /><asp:RequiredFieldValidator ID="rfvGroup" runat="server" CssClass="errormessage" ControlToValidate="ddlGroup" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td style="width:4%;"></td>
                    <td style="width:20%;">Contact Mobile1:<span class="errormessage">*</span></td>                
                    <td style="width:28%;"><asp:TextBox ID="txtContactMob1" runat="server" CssClass="textbox" MaxLength="15" Width="250" TabIndex="13"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvContactMob1" runat="server" CssClass="errormessage" ControlToValidate="txtContactMob1" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td>Location:<span class="errormessage">*</span></td>
                    <td><asp:DropDownList ID="ddlLoc" runat="server" AutoPostBack="true" CssClass="dropdownlist" TabIndex="1" OnSelectedIndexChanged="ddlLoc_SelectedIndexChanged"><asp:ListItem Value="0" Text="---Select---"></asp:ListItem></asp:DropDownList><br /><asp:RequiredFieldValidator ID="rfvLoc" runat="server" CssClass="errormessage" ControlToValidate="ddlLoc" InitialValue="0" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>Contact EmailId1:</td>
                    <td>
                        <asp:TextBox ID="txtEmail1" runat="server" CssClass="textbox" MaxLength="50" Width="250" TabIndex="14"></asp:TextBox><br />
                        <asp:RegularExpressionValidator ID="revEmail1" runat="server" ControlToValidate="txtEmail1" CssClass="errormessage" ValidationGroup="Save"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td>Area:<span class="errormessage">*</span></td>
                    <td><asp:DropDownList ID="ddlArea" runat="server" CssClass="dropdownlist" TabIndex="2"><asp:ListItem Value="0" Text="---Select---"></asp:ListItem></asp:DropDownList><br /><asp:RequiredFieldValidator ID="rfvArea" runat="server" CssClass="errormessage" ControlToValidate="ddlArea" InitialValue="0" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                ...
                <tr>
                    <td>CorporateOrLocal:<span class="errormessage">*</span></td>
                    <td>
                    ...
                    <td><asp:TextBox ID="txtContactMob2" runat="server" CssClass="textbox" MaxLength="15" Width="250" TabIndex="17"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Customer Name:<span class="errormessage">*</span></td>
                    <td><asp:TextBox ID="txtName" runat="server" CssClass="textbox" MaxLength="60" Width="250" TabIndex="5"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvName" runat="server" CssClass="errormessage" ControlToValidate="txtName" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>Contact EmailId2:</td>
                    <td>
                        <asp:TextBox ID="txtEmail2" runat="server" CssClass="textbox" MaxLength="50" Width="250" TabIndex="18"></asp:TextBox><br />
                        <asp:RegularExpressionValidator ID="revEmail2" runat="server" ControlToValidate="txtEmail2" CssClass="errormessage" ValidationGroup="Save"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td>Address:<span class="errormessage">*</span></td>
                    <td><asp:TextBox ID="txtAddress" runat="server" CssClass="textbox" MaxLength="200" TextMode="MultiLine" Rows="5" Width="250" TabIndex="6"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvAddr" runat="server" CssClass="errormessage" ControlToValidate="txtAddress" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtPhone1" runat="server" CssClass="textbox" MaxLength="50" Width="250" TabIndex="9"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvPhone1" runat="server" CssClass="errormessage" ControlToValidate="txtPhone1" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>TAN:</td>
                ...
                <tr>
                    <td>Phone2:</td>
                    <td><asp:TextBox ID="txtPhone2" runat="server" CssClass="textbox" MaxLength="50" Width="250" TabIndex="10"></asp:TextBox></td>
                    <td></td>
                    <td>BIN:</td>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtPerson1" runat="server" CssClass="textbox" MaxLength="50" Width="250" TabIndex="11"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvPerson1" runat="server" CssClass="errormessage" ControlToValidate="txtPerson1" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>IEC:</td>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="txtDesig1" runat="server" CssClass="textbox" MaxLength="50" Width="250" TabIndex="12"></asp:TextBox><br /><asp:RequiredFieldValidator ID="rfvDesig1" runat="server" CssClass="errormessage" ControlToValidate="txtDesig1" ValidationGroup="Save"></asp:RequiredFieldValidator></td>
                    <td></td>
                    <td>Is Active?:</td>
                ...
                <tr>
                    <td colspan="5">
                        <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Save" 
                            ValidationGroup="Save" OnClick="btnSave_Click" TabIndex="26" />&nbsp;&nbsp;<asp:Button 
                            ID="btnBack" runat="server" CssClass="button" Text="Back" 
                            OnClientClick="javascript:window.location.href='ManageCustomer.aspx';return false;" 
                            TabIndex="27" />
                    </td>
                </tr>
            </table>
