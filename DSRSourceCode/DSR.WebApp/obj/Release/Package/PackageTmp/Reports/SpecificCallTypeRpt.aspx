<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpecificCallTypeRpt.aspx.cs" Inherits="DSR.WebApp.Reports.SpecificCallTypeRpt"
    MasterPageFile="~/Site.Master" Title=":: Shipping :: Specific Call Type Report" %>
        ...
        <table>
            <tr>
                ...
                <td style="padding-right:20px;vertical-align:top;">
                    <asp:DropDownList ID="ddlType" runat="server"><asp:ListItem Value="0" Text="All"></asp:ListItem></asp:DropDownList>
                </td>
                <td class="label" style="padding-right:5px;vertical-align:top;">
